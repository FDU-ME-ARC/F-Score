...
module ds_z_type_core #
(

	parameter integer FORM_WIDTH = 32,
	parameter integer DATA_WIDTH = 32,
	parameter 		  FRAG_TYPE = `Z_TYPE,
...
/*------------ result output ----------------*/
	...
	output	wire						zt_cmp_done,
	input   wire                        ds_blocked
);

wire							frag_gen_done;
//wire	[4 : 0]					pep_read_addr;

wire	[4 : 0] 				res_read_addr;
//wire  	[DATA_WIDTH*40-1:0]		mz_data_1; 
//wire  	[DATA_WIDTH*40-1:0]		mz_data_2; 
wire  	[DATA_WIDTH*8 -1:0]   	p_data;
wire  	[DATA_WIDTH*40-1:0]		mz_data; 
ds_bwd_frag #
	(
