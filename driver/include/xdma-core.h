...
/* disable debugging */
	...
	#define dbg_io(fmt, ...) printk("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_fops(fmt, ...) printk("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_perf(fmt, ...) pr_debug("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_sg(fmt, ...) printk("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_irq(fmt, ...) printk("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_init(fmt, ...) printk("%s():" fmt, \
		__func__, ##__VA_ARGS__)

	#define dbg_tfr(fmt, ...) printk("%s(): %s%c: " fmt, \
		__func__, \
